...
describe("allIntegrations", () => {
  ...
  it("is an array containing hubspot-crm", () => {
    expect(allIntegrations.some((i) => i.id === "hubspot-crm")).toBe(true);
  });
  ...
  it("is an array containing linkedin-ads", () => {
    expect(allIntegrations.some((i) => i.id === "linkedin-ads")).toBe(true);
  });
