...
const toolRiskMap: Record<string, ToolRiskLevel> = {
  ...
  github__push_files: "write",
  github__search_repositories: "read",
  github__create_repository: "write",
  github__fork_repository: "write",
  github__create_branch: "write",
  github__list_commits: "read",
  github__create_issue: "write",
  github__list_issues: "read",
  github__get_issue: "read",
  github__update_issue: "write",
  github__add_issue_comment: "write",
  github__search_issues: "read",
  github__create_pull_request: "write",
  github__list_pull_requests: "read",
  github__get_pull_request: "read",
  github__get_pull_request_files: "read",
  github__get_pull_request_status: "read",
  github__get_pull_request_comments: "read",
  github__get_pull_request_reviews: "read",
  github__create_pull_request_review: "write",
  github__merge_pull_request: "destructive",
  github__update_pull_request_branch: "write",
  github__search_code: "read",
  github__search_users: "read",

  // ── Supabase ──
  supabase__list_tables: "read",
  supabase__list_extensions: "read",
  supabase__list_migrations: "read",
  supabase__apply_migration: "destructive",
  supabase__execute_sql: "destructive",
  supabase__get_logs: "read",
  supabase__get_advisors: "read",
  supabase__get_project_url: "read",
  supabase__get_publishable_keys: "read",
  supabase__generate_typescript_types: "read",
  supabase__list_edge_functions: "read",
  supabase__get_edge_function: "read",
  supabase__deploy_edge_function: "write",
  supabase__list_projects: "read",
  supabase__list_organizations: "read",
  supabase__search_docs: "read",
  supabase__create_branch: "write",
  supabase__list_branches: "read",
  supabase__delete_branch: "destructive",
  supabase__merge_branch: "destructive",
  supabase__reset_branch: "destructive",
  supabase__rebase_branch: "write",
