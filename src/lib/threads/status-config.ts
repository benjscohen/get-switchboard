...
export const STATUS_CONFIG: Record<
  SessionStatus,
  { label: string; detailLabel: string; variant: "default" | "accent" | "success" | "destructive" }
> = {
  ...
  failed: { label: "Failed", detailLabel: "Failed", variant: "destructive" },
  timeout: { label: "Timeout", detailLabel: "Timed out", variant: "destructive" },
};
