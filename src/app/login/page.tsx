    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <Card hover={false} className="w-full max-w-sm text-center">
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-3 rounded-lg bg-white border border-border px-4 py-2.5 text-sm font-medium text-text-primary transition-colors hover:bg-bg-hover"
        >
